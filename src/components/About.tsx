  ...
  const highlights = [
    {
      ...
      title: "CSE Student",
      description:
        "Undergraduate student building strong foundations in core computer science, algorithms, and system principles.",
    ...
    },
    {
      ...
      description:
        "Developing responsive web applications with React, modern JavaScript, Tailwind CSS, and RESTful APIs.",
    ...
    },
    {
      ...
      description:
        "Exploring predictive modeling, classification workflows, and data pipelines using Python and Scikit-learn.",
    ...
    },
    {
      ...
      description:
        "Practicing algorithmic thinking, data structures, and clean coding through coursework in C/C++.",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p
            className={`text-base sm:text-lg leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
          >
            Turning curiosity and academic computer science concepts into
            practical, functioning software.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-base sm:text-lg leading-relaxed">
              <p className={isDark ? "text-slate-200" : "text-slate-700"}>
                ...
                turning ideas into practical projects. I’m currently building my
                skills in web development, software engineering, machine
                learning, and problem solving through coursework and hands-on
                projects.
              </p>
              <p className={isDark ? "text-slate-300" : "text-slate-600"}>
                My learning journey includes developing web applications,
                exploring machine learning workflows, working with computer
                graphics and digital image processing, and continuously
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {highlights.map((item, idx) => (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-x-0 top-0 h-24 bg-gradient-to-b ${item.accentColor} opacity-20 rounded-t-3xl pointer-events-none group-hover:opacity-40 transition-opacity`}
                  />
