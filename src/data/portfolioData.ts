...
export const certifications: CertificationItem[] = [
  ...
  },
  {
    ...
    issuer: 'IEEE',
    date: '2026',
    description: 'Recognized as a Student Member in good standing, denoting a personal and professional commitment to the advancement of technology.',
  ...
  },
  {
    ...
    date: '2026',
    description: 'Student Member of IEEE Women in Engineering, a global network supporting and inspiring women in engineering and technology.',
    credentialUrl: undefined,
    verified: true,
...
export const achievementsData: AchievementItem[] = [
  {
    ...
    category: 'Workshop',
    organization: 'National Conference on Robotics & IoT, Dept. of CSE, BSFMSTU',
    date: '2024',
    description: 'Participated in a national-level workshop exploring robotics and IoT concepts, hands-on sessions, and applied engineering practices.',
    icon: 'Layers',
    isPlaceholder: false,
  ...
  },
  {
    ...
    organization: 'National Conference on Robotics & IoT, Dept. of CSE, BSFMSTU',
    date: '2024',
    description: 'Presented a research poster at the National Conference on Robotics & IoT, recognized as part of the Top Girls Team.',
    icon: 'Trophy',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '08 May 2024',
    description: 'Participated in the Innovation Showcasing programme organized by the E-Governance and Innovation Committee at Bangamata Sheikh Fojilatunnesa Mujib Science & Technology University.',
    icon: 'Sparkles',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '2024',
    description: 'Secured 3rd position in a subject-based video content competition themed "Smriti, Sangram O Rashtrachinta: July-August 2024 Sмrone" on the July Uprising.',
    icon: 'Award',
    isPlaceholder: false,
  ...
  },
  {
    ...
    category: 'Competition',
    organization: 'National Debate Federation Bangladesh & JSTU Debating Society',
    date: '2025',
    description: 'Actively participated in the First NDF BD Debate Festival organized by the JSTU Debating Society, engaging in the battle of ideas on an intellectual platform.',
    icon: 'Award',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '2023',
    description: 'Awarded the Merit Scholarship-2023 for securing 2nd position at the 1st Year B.Sc Engineering Examination, Dept. of CSE.',
    icon: 'GraduationCap',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '2025',
    description: 'Recognized as part of the Top Girls Team at the JSTU Inter-University Programming Contest (IUPC) 2025.',
    icon: 'Trophy',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '2024',
    description: 'Grateful to have secured 2nd place in the "Phire Dekha July" Essay and Quiz Competition.',
    icon: 'Award',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '22 July 2026',
    description: 'Participated in the seminar on "Paving Pathways to Professional Development and International Recognition through IEEE" at JSTU.',
    icon: 'Layers',
    isPlaceholder: false,
  ...
  },
  {
    ...
    date: '2 August 2026',
    description: 'Participated in the webinar "IEEE Beyond Membership: Unlocking Research, Innovation, Funding, Awards, and Leadership Opportunities."',
    icon: 'Layers',
    isPlaceholder: false,
